...
## Create column for Abbreviated Month and Year
 ...
 1. Enter `Short_Month = FORMAT([Month_Ending], "MMM yyyy")` as the calculation \
 **_NOTE_** how this column is interpreted as Text and not Date, this will change how the axis is displayed.
